...
int main(void)
{
    ...
    //if( pthread_create(&t_SoftDog, NULL, f_softdog, NULL) == -1)  printf(" Nie mozna utworzyć wątku");
    ...
    //if(pthread_join(t_SoftDog, &result) == -1)printf("Blad oczekiwania na zakonczenie watku t_Printer");
